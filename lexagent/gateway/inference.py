...
This module is the single choke-point between LexAgent node logic and cloud
...
Circular import rule: this module imports ONLY from lexagent.config,
lexagent.security.audit, and lexagent.gateway.anonymizer. Never from
lexagent.nodes, lexagent.graph, or any other LangGraph layer.
"""
...
from lexagent.security.audit import AuditAction, log_action
