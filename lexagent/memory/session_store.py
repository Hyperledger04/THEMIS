...
def db_path(sessions_db: str = "~/.lexagent/sessions.db") -> Path:
    """Return the absolute Path to the sessions database."""
    return Path(sessions_db).expanduser()


@contextmanager
def _connect(sessions_db: str = "~/.lexagent/sessions.db") -> Generator[sqlite3.Connection, None, None]:
    """
...
def init_db(sessions_db: str = "~/.lexagent/sessions.db") -> None:
    """
...
def save_session(state: LexState, sessions_db: str = "~/.lexagent/sessions.db") -> int:
    """
...
def search_sessions(query: str, limit: int = 10, sessions_db: str = "~/.lexagent/sessions.db") -> List[dict]:
    """
...
def list_sessions(limit: int = 20, sessions_db: str = "~/.lexagent/sessions.db") -> List[dict]:
...
def get_session_state(matter_id: str, sessions_db: str = "~/.lexagent/sessions.db") -> Optional[dict]:
    """
...
def update_session(state: LexState, sessions_db: str = "~/.lexagent/sessions.db") -> None:
    """
...
def delete_reminder(reminder_id: int, sessions_db: str = "~/.lexagent/sessions.db") -> bool:
...
def mark_reminder_fired(reminder_id: int, sessions_db: str = "~/.lexagent/sessions.db") -> None:
