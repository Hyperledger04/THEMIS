...
Usage:
    python -m lexagent.skills.build_skill lexagent/skills/indian_doc_formatter
    python -m lexagent.skills.build_skill lexagent/skills/indian_doc_formatter --out dist/
...
WHY a separate build step instead of just reading directories at runtime:
  ...
  `cp my_skill.skill ~/.lexagent/skills/`, no directory structure to preserve.
"""
