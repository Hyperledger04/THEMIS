...
def test_write_docx_no_lexagent_footer_in_filing(tmp_path):
    # The filing .docx must NOT contain internal LexAgent metadata.
    # Matter ID, "Generated by LexAgent", and "Phase 5 draft" are lawyer notes
    ...
    assert "Generated by LexAgent" not in full_text
