...
# Keeping the fee table in themis/data/court_fees.yaml means a lawyer can update the
...
def calculate_court_fee(matter_type: str, suit_value: float = 0.0, state: str = "") -> dict:
    ...
    if not row:
        row = {
            ...
            "note": "Add this matter type to themis/data/court_fees.yaml for future lookups.",
        }
