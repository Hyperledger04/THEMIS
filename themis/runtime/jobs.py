"""
MVP job handlers for the Themis living-agent worker.
...
from themis.runtime.worker import register_handler
...
async def handle_process_uploaded_documents(job, runtime_repo, ledger=None, halt_flag=None):
    ...
    from themis.ingestion.documents import ingest_file
    result = ingest_file(
        file_path=file_path,
...
async def handle_extract_facts_and_issues(job, runtime_repo, ledger=None, halt_flag=None):
    ...
    from themis.ingestion.documents import _extract_text
    ...
    from themis.ingestion.extractors import extract_from_pages, persist_extraction
...
async def handle_build_chronology(job, runtime_repo, ledger=None, halt_flag=None):
    ...
    from themis.ingestion.chronology import build_and_format_chronology
    ...
    from datetime import datetime, timezone
    from themis.runtime.models import AgentArtifact
