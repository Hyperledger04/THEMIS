# themis/gateway/voice.py — Voice AI Gateway for Themis.
#
...
async def voice_websocket(websocket: WebSocket, session_id: str) -> None:
    ...
    # Send greeting
    greeting = (
        "Welcome to Themis. I'm ready to help you draft your legal document. "
...
async def twilio_incoming(request: Request) -> Response:
    ...
    greeting = (
        "Welcome to Themis, your AI legal assistant. "
