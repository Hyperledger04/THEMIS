...
# Presidio is an optional dependency (pip install themis[pii]).
...
# Themis internal matter IDs: "matter_abc123", "matter_xxxxxxxx"
...
if _PRESIDIO_AVAILABLE:
    ...
    class MatterIdRecognizer(EntityRecognizer):
        """Recognizes Themis internal matter_xxx IDs for pseudonymization."""
