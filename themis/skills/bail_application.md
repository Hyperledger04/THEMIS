...
## PARTIES
[Accused/Applicant block] ... ACCUSED/APPLICANT
VERSUS
STATE OF [X] ... RESPONDENT

## NATURE_OF_ACCUSATION
FIR No. [X] dated [date], P.S. [station], under Sections [X] IPC/BNS ...

## FACTS_IN_BRIEF
1. That the Applicant ...

## ANTECEDENTS
That the Applicant has no prior criminal record / has been acquitted in ...

## CUSTODY_PERIOD
That the Applicant has been in custody since [date] ...

## GROUNDS_FOR_BAIL
Ground 1: That the Applicant is a first-time offender ...
Ground 2: ...

## SURETY_OFFER
That the Applicant is willing to furnish surety of Rs. [X] ...
